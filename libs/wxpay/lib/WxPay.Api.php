...
class WxPayApi
{
	...
	{		
		...
		if($useCert == true){
			...
			curl_setopt($ch,CURLOPT_SSLCERT, ROOT_DIR.'app_api/public/wxpayApp/cert/apiclient_cert.pem');
			curl_setopt($ch,CURLOPT_SSLKEYTYPE,'PEM');
			curl_setopt($ch,CURLOPT_SSLKEY, ROOT_DIR.'app_api/public/wxpayApp/cert/apiclient_key.pem');
		}
		//post提交方式
