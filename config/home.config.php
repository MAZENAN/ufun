...
return [
    ...
    'ROUTE_DATAS' => [
        'rule' => [
            ...
            'search' => ['@^/sch-(?P<agefrom>\d+)-(?P<camp_days>\d+)-(?P<starting_city>\d+)-(?P<order>\d+)\.html@i', ['ctl' => 'search', 'act' => 'index']], //大类
            'glcamp' => ['@^/gs-(?P<camp_country>\d+)-(?P<camp_category>\d+)-(?P<agefrom>\d+)-(?P<camp_type>\d+)-(?P<boarding>\d+)-(?P<order>\d+)\.html@i', ['ctl' => 'glcamp', 'act' => 'index']], //大类
            'cncamp' => ['@^/ns-(?P<destination>\d+)-(?P<camp_type>\d+)-(?P<theme>\d+)-(?P<agefrom>\d+)-(?P<camp_days>\d+)-(?P<starting_city>\d+)-(?P<order>\d+)\.html@i', ['ctl' => 'cncamp', 'act' => 'index']], //大类
