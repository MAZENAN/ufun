<?php /* Smarty version Smarty-3.1.19, created on 2019-05-14 16:51:46
         compiled from ".\Apps\Home\views\glcamp_detail.tpl" */ ?>
<?php /*%%SmartyHeaderCode:154315cda81a2448d13-85019928%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'bf9db0a2c1567eefebef6c09cc1c73d5e21235e8' => 
    array (
      0 => '.\\Apps\\Home\\views\\glcamp_detail.tpl',
      1 => 1491472327,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '154315cda81a2448d13-85019928',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5cda81a2546894_98354494',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5cda81a2546894_98354494')) {function content_5cda81a2546894_98354494($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_minimg')) include 'E:\\WWW\\waimai\\Web\\samao\\smarty\\ext\\plugins\\modifier.minimg.php';
...
<?php if ($_smarty_tpl->tpl_vars['rs']->value['ncost']==0) {?>(已截止)<?php }?>
      <div class="thecon-intro-share">       <!-- JiaThis Button BEGIN -->
...
.html">
          <div class="thecon-inlis-left">
            <ul>
               <li>营地位置：<?php echo $_smarty_tpl->tpl_vars['rs']->value['camp_location'];?>
</li>
              <!-- <li>营地类别：<?php echo DB::getval('@pf_camp_category','name',$_smarty_tpl->tpl_vars['rs']->value['camp_category']);?>
</li>-->
...
<?php }?></span> 岁&nbsp;&nbsp;</li>
             <!--  <li>性别要求：<?php echo ((FALSE!==$_tempkey=array_search($_smarty_tpl->tpl_vars['rs']->value['gender'],array('all','boy','girl'))) && array_key_exists($_tempkey,$_temparr=array('不限制','男孩','女孩'))?$_temparr[$_tempkey]:'');?>
 </li> -->
             <li>是否亲子：<?php echo ((FALSE!==$_tempkey=array_search($_smarty_tpl->tpl_vars['rs']->value['camp_type'],array(1,2,3))) && array_key_exists($_tempkey,$_temparr=array('亲子同游','学生单飞','单飞亲子均可'))?$_temparr[$_tempkey]:'');?>
 </li>
            </ul>
          </div>
          <div class="thecon-inlis-right">
            <ul>
              <!--  <li><h1>服务机构：<?php echo $_smarty_tpl->tpl_vars['rs']->value['mechanism'];?>
</h1></li> -->
...
"> -->
                 <input type="hidden" name="type" value="glcamp">
                <div class="clear"></div>
              </li>
            </ul>
          </div>
...
?>
 ...
 <li class="collection"><?php if ($_smarty_tpl->tpl_vars['rs']->value['favorites']>0) {?><a href="/favorites/delete.html?camp=<?php echo $_smarty_tpl->tpl_vars['rs']->value['id'];?>
