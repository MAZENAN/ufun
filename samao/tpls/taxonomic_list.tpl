...
<link href="__RES__/css/list.cate.css" rel="stylesheet" type="text/css" />
<script type="text/javascript" src="__RES__/js/jquery.cookie.js"></script>
<script type="text/javascript" src="__RES__/js/samao.taxonomic.js"></script>
<script type="text/javascript">
$(function(){$.taxonomic('__SELF__/list');});
</script>
...
<tr pid="{@$rs._id@}" {@block name=tr_attr@}{@/block@} onmouseover="this.oldBgcolor=this.style.backgroundColor;this.style.backgroundColor='#FCFCF8';" onmouseout="this.style.backgroundColor=this.oldBgcolor">
