...
class WxPayApi
{
	...
	{		
		...
		if($useCert == true){
            ...
            curl_setopt($ch,CURLOPT_SSLCERT, dirname(dirname(__FILE__)).'/cert'.DIRECTORY_SEPARATOR.'apiclient_cert.pem');
            curl_setopt($ch,CURLOPT_SSLKEYTYPE,'PEM');
            curl_setopt($ch,CURLOPT_SSLKEY, dirname(dirname(__FILE__)).'/cert'.DIRECTORY_SEPARATOR.'apiclient_key.pem');
		}
		//post提交方式
