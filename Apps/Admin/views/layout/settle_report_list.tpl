...
<div class="form-list">
<h3>订单详情<a onclick="return confirm('确定要导出表格吗？');" class="samao-link-minibtn" href="__SELF__/exportList?merchant_id={@$sch.merchant_id@}&settle_time={@$sch.settle_time@}&settle_time_to={@$sch.settle_time_to@}" style="float:right">导出表格</a></h3>
</div>
<th width="130">商户</th>
<th width="80">订单号</th>
...
<td align="center">
	<span class="blu">{@$rs.merchant_id|smval:'@pf_merchant':'name'@}</span>
</td>
<td align="center">
	<span class="blu">{@$rs.order_id@}</span>
</td>
