...
//            'notify'=>'卖家通知'
        ...
        $this->script = '$(function(){
            var var_arr = \'[\';
            $("#cate_id").on("click",".btnget",function(){
              var mids =  $("#cate_id input")
              $("#cate_id_info").html("")
              $("#cate_id_info").attr("class","field-info")
              var_arr = \'[\';        
                   $.each(mids,function(i,e){
                        var ifcheckd = $(e).prop(\'checked\')
                        if(ifcheckd){
                            if(var_arr==\'[\'){
                            var_arr = var_arr + \'\"\' +$(e).val() + \'\"\'
                            }else{
                            var_arr = var_arr + \',\"\' +$(e).val() + \'\"\'
                            }
                   ...
                   var_arr += \']\'
                   if(var_arr==\'[]\'){
                       $(\'#data_val_cate_id\').val(\'\')
                   }else{
                        $(\'#data_val_cate_id\').val(var_arr)
                   }                  
                });
            $("#merchant_id").change(
                function(){
