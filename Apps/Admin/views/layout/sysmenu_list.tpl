...
<!--标题-->
{@block name=title@}系统菜单栏目{@/block@}

<!--表格顶部区域-->
{@block name=table_topbar@}
<div class="smbox-list-toptab">
<a href="__SELF__/add" class="samao-link-btn samao-link-btn-add">新增系统菜单</a>&nbsp;&nbsp;
<form method='get'>
{@form_select header='系统菜单' options=DB::getopts('@pf_sysmenu','id,title',0,"pid=0") style="width:100px;" onchange='this.form.submit();' value="{@$id@}" name="id" model=$model@}&nbsp;&nbsp;
</form>
</div>
{@/block@}
